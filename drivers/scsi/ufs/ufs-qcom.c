...
static void ufs_qcom_set_caps(struct ufs_hba *hba)
{
	...
	if (!host->disable_lpm) {
		...
		/*qcom origin code: UFSHCD_CAP_CLK_SCALING | UFSHCD_CAP_AUTO_BKOPS_SUSPEND |
		To avoid deadlock problems caused by clkscaling, plan to turn off clkscaling in sm8475
		*/
